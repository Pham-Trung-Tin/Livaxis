    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#fffdf9_0%,#fbf7f1_52%,#f4efe6_100%)] text-[#141311]">
      ...
      <main className="pt-[72px]">
        ...
        <section className="relative -mt-10 pb-20">
          <div className="mx-auto flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-6 [&::-webkit-scrollbar]:hidden">
      ...
      <AnimatePresence>
        {paymentOpen && paymentPlan ? (
          <motion.div
            className="fixed inset-0 z-[110] flex items-end justify-center p-0"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
            ...
            <motion.div
              className="relative w-full max-w-lg overflow-hidden rounded-t-[28px] border border-white/10 bg-white shadow-[0_30px_80px_rgba(0,0,0,0.28)]"
...
function PricingCard({
  ...
  return (
    <motion.div
      ...
      className={`relative flex min-h-[640px] w-[85vw] max-w-[340px] shrink-0 snap-center cursor-pointer flex-col overflow-hidden rounded-2xl ${selected ? 'ring-1 ring-[#1a1a1a]' : ''}`}
      style={{
        background: 'white',
