...
const ProductCard = forwardRef<HTMLElement, {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative mb-3 overflow-hidden rounded-xl bg-[#f7f5f2] cursor-pointer"
      ...
      <div className="flex flex-1 flex-col gap-1.5 px-0.5">
        <div>
          <h3
            className="mb-0.5 cursor-pointer text-[13px] leading-snug text-black line-clamp-1"
          ...
          <p
            className="text-[10px] leading-relaxed text-neutral-400 line-clamp-1"
        ...
        <span
          className="text-[13px] text-[#5a4a38]"
        ...
        <div className="mt-1 flex gap-2">
          ...
          <a
            ...
            className="flex flex-1 items-center justify-center rounded-lg border border-[#ee4d2d]/20 py-2 bg-[#ee4d2d]/[0.02]"
          >
            <ShoppingBag size={13} className="text-[#ee4d2d]/80" strokeWidth={1.5} />
          </a>
...
export function DiscoveryMobile() {
  const navigate = useNavigate()
  const { t } = useLanguage()
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        <div className="relative overflow-hidden bg-[#f7f5f1]">
          ...
          <div className="relative px-5 py-12 text-center">
            <motion.span
              ...
              className="mb-3 block text-[10px] uppercase tracking-[0.2em] text-[#a08c6a]"
              style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}
            >
            ...
            <motion.h1
              ...
              className="mb-4 text-[2.2rem] leading-tight text-black"
            ...
            <motion.p
              ...
              className="mx-auto max-w-[280px] text-[13px] leading-relaxed text-neutral-500"
              style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}
            >
        ...
        <div className="flex flex-col">
          ...
          <div className="min-w-0 flex-1">
            <div className="mb-6 flex items-center justify-between border-b border-black/6 pb-4">
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-black/12 px-3 py-2 bg-white"
                  style={{ fontFamily: 'Inter, sans-serif' }}
                >
                  <SlidersHorizontal size={13} className="text-neutral-500" />
                  <span className="text-[10px] uppercase tracking-[0.1em] text-neutral-600" style={{ fontWeight: 500 }}>
            ...
            {filtered.length === 0 ? (
              ...
              >
                <p
                  className="mb-2 text-[18px] text-neutral-400"
                  style={{ fontFamily: 'Playfair Display, serif', fontWeight: 400 }}
                >
                ...
                <button
                  ...
                  className="mt-4 rounded-full border border-black/12 px-5 py-2 text-[10px] uppercase tracking-[0.15em] text-neutral-600"
                  style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}
                >
              ...
              <motion.div layout className="grid grid-cols-2 gap-x-3 gap-y-8">
        ...
        {mobileFiltersOpen ? (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-0 z-50 h-full w-[300px] overflow-y-auto bg-white shadow-2xl"
            >
      ...
      <section className="border-t border-black/5 bg-[#f7f5f1] py-12">
        <div className="px-5 text-center">
          <span
            className="mb-3 block text-[9px] uppercase tracking-[0.2em] text-[#a08c6a]"
            style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}
          >
            {t('discovery.promiseTitle')}
          </span>
          <h2
            className="mx-auto mb-3 max-w-[280px] text-[1.4rem] leading-snug text-black"
            style={{ fontFamily: 'Playfair Display, serif', fontWeight: 400 }}
          >
            {t('discovery.promiseSubtitle')}
          </h2>
          <p
            className="mx-auto max-w-[300px] text-[12px] leading-relaxed text-neutral-400"
            style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}
          >
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6">
            {[
              ...
              <div key={item.label} className="text-center">
                <p
                  className="mb-1 text-[1.5rem] text-black"
                  style={{ fontFamily: 'Playfair Display, serif', fontWeight: 400 }}
                >
                  {item.stat}
                </p>
                <p
                  className="text-[9px] uppercase tracking-[0.1em] text-neutral-400"
                  style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400 }}
                >
                  {item.label}
                </p>
